...
def printHelp():
    print('=' * 100)
    print('Welcome to use myRPC Generator, this is help document:\n')
    ...
    print('Usage:')
    print('myRPC_generator.py -[options][target]\n')
    print('Options:')
    print('-h, --help')
    ...
    print('')
    print('For example:')
    print('myRPC_generator.py -i order_server.proto -o ./')
...
def gen_conf_file():
    print('=' * 100)
    file_name = "myRPC.xml"
    print('Begin to generate myRPC conf file')
    ...
    file.close()
    print('succ write to ' + out_file)
    print('End generate myRPC conf file')
    print('=' * 100)
...
def generate_framework_code(): 
    ...
    print('End generate myRPC framework code')
    print('=' * 100)
...
def generate_project():
    ...
    try:
        ...
        print('=' * 150)
        print("Begin to generate myRPC server") 
        ...
        print('Succ generate myRPC project')
        print('=' * 150)
    
    except Exception as e:
        print("Failed to generate myRPC server, err: " + str(e))
        print('=' * 150)
